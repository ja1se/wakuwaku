    ...
    <footer className="bg-[#020617] border-t border-slate-800/50 py-16 px-14 text-slate-400">
      <div className="max-w-[1280px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
        ...
        <div className="flex flex-col gap-4">
          <img src="/assets/logo.svg" alt="WAKUWAKU" className="h-[24px] w-fit" />
          <p className="text-sm leading-relaxed max-w-[280px]">
            내일이 기다려지는 기분 좋은 떨림, 지금 와쿠와쿠에서 당신의 마음을 울릴 인생 일드를 찾아보세요.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <ul className="flex flex-col gap-2 text-sm">
            ...
            <li className="hover:text-primary transition-colors cursor-pointer">고객센터</li>
            <li className="hover:text-primary transition-colors cursor-pointer">계정 관리</li>
          </ul>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <ul className="flex flex-col gap-2 text-sm">
            <li className="hover:text-primary transition-colors cursor-pointer">이용약관</li>
            <li className="hover:text-primary transition-colors cursor-pointer">개인정보 처리방침</li>
            <li className="hover:text-primary transition-colors cursor-pointer">쿠키 설정</li>
          </ul>
        </div>
      ...
      <div className="mt-16 pt-8 border-t border-slate-800/30 text-center">
        <p className="text-xs text-slate-500">
          © 2024 WAKUWAKU Streaming Inc. All rights reserved.
        </p>
      </div>
    </footer>
  );
